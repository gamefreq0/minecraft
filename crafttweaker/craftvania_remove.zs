...
function craftvania_remove_main() as void
{
    ...
    var itemsToHide = [
        <craftvania2:cv_leviathan_spawn_egg>,
        <craftvania2:cvaxearmor_spawn_egg>,
        <craftvania2:cvcreature_spawn_egg>,
        <craftvania2:cvectoplasm_spawn_egg>,
        <craftvania2:cvfireman_spawn_egg>,
        <craftvania2:cvfleaman_spawn_egg>,
        <craftvania2:cvfrozenshade_spawn_egg>,
        <craftvania2:cvghoul_spawn_egg>,
        <craftvania2:cvgoldmedusahead_spawn_egg>,
        <craftvania2:cvgoldskeleton_spawn_egg>,
        <craftvania2:cvheatshade_spawn_egg>,
        <craftvania2:cvkillerdoll_spawn_egg>,
        <craftvania2:cvknight_spawn_egg>,
        <craftvania2:cvlegion_spawn_egg>,
        <craftvania2:cvlegionzombie_spawn_egg>,
        <craftvania2:cvmedusahead_spawn_egg>,
        <craftvania2:cvmerman_spawn_egg>,
        <craftvania2:cvmudman_spawn_egg>,
        <craftvania2:cvmummy_spawn_egg>,
        <craftvania2:cvnemesis_spawn_egg>,
        <craftvania2:cvpoisonghoul_spawn_egg>,
        <craftvania2:cvredskeleton_spawn_egg>,
        <craftvania2:cvskeleton_sprinter_spawn_egg>,
        <craftvania2:cvstonegolem_spawn_egg>,
        <craftvania2:cvvampire_spawn_egg>,
        <craftvania2:cvwerewolf_spawn_egg>,
        <craftvania2:cvwhipskeleton_spawn_egg>,
        <craftvania2:cvwoodgolem_spawn_egg>
    ] as IItemStack[];
