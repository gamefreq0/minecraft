...
function doomweapon_remove_main() as void
{
    ...
    var itemsToRemove = [
        ...
        <item:doom:icon_wall1>,
        <item:doom:icon_wall2>,
        <item:doom:icon_wall3>,
        <item:doom:icon_wall4>,
        <item:doom:icon_wall5>,
        <item:doom:icon_wall6>,
        <item:doom:icon_wall7>,
        <item:doom:icon_wall8>,
        <item:doom:icon_wall9>,
        <item:doom:icon_wall10>,
        <item:doom:icon_wall11>,
        <item:doom:icon_wall12>,
        <item:doom:icon_wall13>,
        <item:doom:icon_wall14>,
        <item:doom:icon_wall15>,
        <item:doom:icon_wall16>,
